    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[25rem] bg-gradient-conic from-blue-600 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[25rem] bg-gradient-conic from-transparent via-transparent to-blue-600 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[25rem] -translate-y-[7rem] bg-blue-700 "
        ></motion.div>

        {/* <div className="absolute inset-auto z-40 h-28 w-full -translate-y-[12.5rem] bg-slate-900 opacity-60 "></div> */}
      </div>
