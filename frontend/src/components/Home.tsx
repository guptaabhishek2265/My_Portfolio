...
const Home = () => {
  ...
  return (
    <div className="pb-20 pt-28 h-lvh w-lvw relative">
      <FloatingNav navItems={navItems} className="z-20" />
      <div className="w-lvw h-lvh fixed z-10 top-0 left-0">
        <Spotlight
      ...
      <div className="flex justify-center fixed  z-10  h-screen flex-row w-full">
        <div className="w-1/2 h-full flex flex-col justify-center pb-40">
          <TextGenerateEffect
            words="Hi! I'm Abhishek Gupta, a Full-stack Web and App Developer"
          ...
          <Dock className="border-0 z-[5000]">
            <DockIcon
              onClick={() => {
                window.open("https://github.com/guptaabhishek2265", "_blank");
              }}
            >
            ...
            <DockIcon
              onClick={() => {
                window.open("mailto:abhishek23102@iiitnr.edu.in", "_blank");
              }}
            >
            ...
            <DockIcon
              onClick={() => {
                window.open("https://t.me/abhi97543", "_blank");
              }}
            >
        ...
        <div className="w-1/2 h-full p-10 hidden sm:flex">
          <LampContainer>
            <motion.h1
              ...
              className="my-12 bg-gradient-to-br from-slate-100 to-slate-300 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
            >
              Abhishek Gupta
            </motion.h1>
          </LampContainer>
